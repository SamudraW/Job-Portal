	...
	<section >
	 ...
	 <?php
			...
			if(isset($_POST['submit']))
			{
				...
				{
					$count = 0;
					$sql="Select * from employer_register where Username = '$_POST[username]' && Password = '$_POST[password]'";
				...
				{
					$count = 0;
					$sql="Select * from user_register where Username = '$_POST[username]' && Password = '$_POST[password]'";
					$res = mysqli_query($conn, $sql);
