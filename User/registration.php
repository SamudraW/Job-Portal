...
<body> 
	...
	<section >
		...
		<div class="box2">
			...
			<h1 style="text-align:center;font-size:35px;font-family:arial;color:white;padding-top:30px;padding-right:30px;"> User Registration Form</h1><br>
		<form name="reg" action="" method="POST">
		   ...
		   <input type="text" name="fname1" placeholder="First Name" required="" class="i1"><br><br><br>
			...
			<input type="text" name="num1" placeholder="Contact No" required="" class="i1"><br><br><br>
	...
	<?php
		   ...
		   {
			 $count=0;
			 $sql1="Select Username from user_register";
		  ...
		  { $sql="insert into user_register
			 (First_Name, Last_Name, Username, Password, Contact_No, Email)values
			 ('$_POST[fname1]','$_POST[lname1]', '$_POST[username1]', '$_POST[password1]', '$_POST[num1]', '$_POST[email1]')";
